...
class HTTP {
  ...
  build() {
    ...
    url.exit.toHTTP09
      .otherwise(
        this.update('req_http_major', 0,
          this.update('req_http_minor', 9, 'header_field_start'))
      );
    ...
    n('header_field_colon')
      ...
      .otherwise(
        this.update('header_state', HEADER_STATE.GENERAL_HEADER,
          'header_field_general'));
    ...
    n('header_value_otherwise')
      .peek('\r', span.headerValue.end().skipTo(n('header_almost_done')))
